...
(function() {
  var BacklogDB, BodyParser, CoffeeScript, Config, CookieParser, Crypto, Eco, Engine, Express, Fs, Gzippo, Http, Https, LocalStrategy, Log, MethodOverride, Morgan, Passport, PasswordHash, Path, ServeStatic, SessionStore, Url, User, Util, WebSocket, WorkingQueue, checkPassword, compact, count, del, ends, extend, flatten, last, merge, newPassword, starts, _, _ref;
